...
function initMap() {
    var myLatLng = { lat: 63.064559, lng: 18.337442 };
...
; (function () {
    ...
    var countDownDate = new Date("Jun 29, 2019 15:00:00").getTime();
    ...
    var x = setInterval(function () {
        ...
        // Display the result in an element with id="demo"
        document.getElementById("days").innerHTML = days + " <small>dagar</small>";
        document.getElementById("daysmobile").innerHTML = days + " <small>dagar kvar</small>";
    ...
    $(document).ready(function () {
        $('.radio-inline').click(function () {
            ...
            if (attendingValue === "False") {
                ...
                document.getElementById("descriptionAccomdation").disabled = true;


            }
            if (attendingValue === "True") {
                document.getElementById("description").disabled = false;
                document.getElementById("Accommondation").disabled = false;
                document.getElementById("NumberOfNights").disabled = false;
                document.getElementById("descriptionAccomdation").disabled = false;
